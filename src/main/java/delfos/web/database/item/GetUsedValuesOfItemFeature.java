 ...
 * @author jcastro
 */
@Path("/Database/GetUsedValuesOfItemFeature")
@Produces(MediaType.TEXT_PLAIN)
public class GetUsedValuesOfItemFeature {
    ...
    public JsonObject getAsJson(@PathParam(FeatureJson.FEATURE_NAME) String featureName) throws CommandLineParametersError {
        ...
        if (featuresMatched.size() == 1) {
            ...
            JsonObjectBuilder jsonObjectBuilder = Json.createObjectBuilder()
                    ...
                    .add(FeatureJson.FEATURE, FeatureJson.createFeatureDetailsJson(feature, datasetLoader.getContentDataset()));
            ...
            return Json.createObjectBuilder()
                    .add("status", "error")
                    .add("message", "Item feature with name '" + featureName + "' does not exist")
